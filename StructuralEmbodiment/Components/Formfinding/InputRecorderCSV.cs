...
namespace StructuralEmbodiment.Components.Formfinding
{
    public class InputRecorderCSV : GH_Component
    {
        ...
        /// </summary>
        public InputRecorderCSV()
          : base("Input Recorder CSV", "IR CSV",
              "Record all inputs on the canvas with a user defined tag as suffix and write data to CSV",
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.FF_InputRecorderCSV;
            }
        }
