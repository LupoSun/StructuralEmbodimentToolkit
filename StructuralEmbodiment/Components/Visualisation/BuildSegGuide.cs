...
namespace StructuralEmbodimentToolkit.Components.Visualisation
{
    public class BuildSegGuide : GH_Component 
    {
        ...
        {
            pManager.AddGenericParameter("Seg Guide", "Seg Guide", "Guides for image Generation", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            string cNModel = "control_seg-fp16";
