...
namespace StructuralEmbodiment.Components.Visualisation
{
    public class SDInitialiser_Legacy : GH_Component
    {
        ...
        /// </summary>
        public SDInitialiser_Legacy()
          : base("SD Initialiser NA", "SDI",
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Core.Util.ConvertToGrayscale(new System.Drawing.Bitmap( Properties.Resources.VIS_SDInitialiser));
            }
        }
        ...
        {
            base.m_attributes = new SDInitialiserNA_ButtonAttributes(this);
        }
    }
    #endregion
    #region GH_ComponentAttributes interface

    public class SDInitialiserNA_ButtonAttributes : Grasshopper.Kernel.Attributes.GH_ComponentAttributes
    {
        GH_Component thisowner = null;
        System.Drawing.RectangleF ButtonBounds2;

        public SDInitialiserNA_ButtonAttributes(GH_Component owner) : base(owner)
        {
            thisowner = owner;
        }
        ...
        public override GH_ObjectResponse RespondToMouseUp(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                var owner = this.Owner as SDInitialiser_Legacy;
